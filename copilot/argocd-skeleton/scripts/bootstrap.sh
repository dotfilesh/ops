...
# Source plan: ops-rebuild-plan.md §2026 — Bootstrap Sequence
#
...
SKELETON_DIR="$(dirname "$SCRIPT_DIR")"
CLUSTER="kclt-01"
ARGOCD_NS="argocd"
K8S_DIR="${SKELETON_DIR}/kubernetes"
...
TALOS_CONFIG_DIR="${SKELETON_DIR}/../../talos/clusters/${CLUSTER}"
